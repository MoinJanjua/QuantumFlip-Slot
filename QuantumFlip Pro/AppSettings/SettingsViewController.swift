...
class SettingsViewController: UIViewController ,UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        settingList = ["Home","About Us","Reset All","Your Suggestions","Share with others"]
...
extension SettingsViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.item == 0 {
            ...
            let alert = UIAlertController(title: "Remove All Data", message: "You're sure you want to reset all the data.", preferredStyle: .alert)
            ...
            let appID = "QuantumFlipSlot" // Replace with your actual App ID
